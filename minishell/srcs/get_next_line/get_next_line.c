...
/*   Updated: 2021/10/18 14:41:17 by msessa           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	ft_init_vars(int fd, char *buf[1024 + 1], char **line)
{
...
static int	ft_update_outputs(int fd, char *buf[1024 + 1], char **line)
{
	if (*buf[fd] != '\0')
	{
