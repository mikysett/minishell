...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/10/26 14:15:13 by apinto            #+#    #+#             */
/*   Updated: 2021/10/26 14:16:09 by apinto           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_list			*parse_command(t_list *tokens, t_cmd *cmd,
					int cmd_id, int cmd_group);
t_list			*parse_pipe(t_list *curr_node, int cmd_id);
t_list			*parse_redir(t_list *curr_node, int cmd_id);
void			create_command_and_redir(t_list *curr_node,
					int cmd_id, int cmd_group);
#endif
